...
impl Field for Fq6
{
    ...
    fn frobenius_map(&mut self, power: usize)
    {
        ...
        self.c1.mul_assign_ref(&FROBENIUS_COEFF_FQ6_C1[power % 6]);
        self.c2.mul_assign_ref(&FROBENIUS_COEFF_FQ6_C2[power % 6]);
    }
    ...
    fn mul_assign_ref(&mut self, other: &Self) {
        ...
        let mut b_b = self.c1;
        let mut c_c = self.c2;
        a_a.mul_assign_ref(&other.c0);
        b_b.mul_assign_ref(&other.c1);
    ...
    fn inverse(&self) -> Option<Self> {
        ...
        match tmp1.inverse() {
            Some(t) => {
                ...
                tmp.c0.mul_assign_ref(&c0);
                tmp.c1.mul_assign_ref(&c1);
                tmp.c2.mul_assign_ref(&c2);
